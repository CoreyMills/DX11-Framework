...
BlurShader::BlurShader(WCHAR* fxFilePath)
{
...
HRESULT BlurShader::CompileShaderFromFile(WCHAR* szFileName, LPCSTR szEntryPoint, LPCSTR szShaderModel, ID3DBlob** ppBlobOut)
{
	HRESULT hr = S_OK;
